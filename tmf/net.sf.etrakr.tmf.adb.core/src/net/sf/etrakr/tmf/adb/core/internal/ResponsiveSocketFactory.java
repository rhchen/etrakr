...
public class ResponsiveSocketFactory implements AdbSocketFactory {
    ...
    if (proxyClass != null) {
      ...
      try{
        ...
        if(o instanceof Socket){
    	  ...
    	  AdbActivator.log(IStatus.ERROR, NLS.bind("An internal error occurred while connecting to {0}", host), e); //$NON-NLS-1$
      }
