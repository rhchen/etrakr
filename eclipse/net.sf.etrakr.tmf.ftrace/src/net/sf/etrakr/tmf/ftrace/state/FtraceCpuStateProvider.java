 ...
 * @since 3.0
 */
public class FtraceCpuStateProvider extends AbstractTmfStateProvider {
    ...
    @Override
    public FtraceCpuStateProvider getNewInstance() {
        return new FtraceCpuStateProvider(this.getTrace());
    }
    ...
    protected void eventHandle(ITmfEvent event) {
        ...
        if (eventName.equals(FtraceStrings.SCHED_SWITCH)) {
            /*
            ...
            try {
            	...
            	TmfFtraceActivator.getDefault().logError("Attribute not found in FtraceCpuStateProvider", e); //$NON-NLS-1$
            }
