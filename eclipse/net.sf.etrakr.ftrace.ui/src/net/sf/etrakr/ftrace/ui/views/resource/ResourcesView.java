...
package net.sf.etrakr.ftrace.ui.views.resource;
...
import net.sf.etrakr.ftrace.ui.views.resource.ResourcesEntry.Type;
...
public class ResourcesView extends AbstractTimeGraphView {
    ...
    /** View ID. */
    public static final String ID = "net.sf.etrakr.ftrace.ui.views.resource.ResourcesView"; //$NON-NLS-1$
    ...
    protected List<ITimeEvent> getEventList(TimeGraphEntry entry,
        ...
        ITmfStateSystem ssq = TmfStateSystemAnalysisModule.getStateSystem(resourcesEntry.getTrace(), FtraceAnalysisModule.ID);
        if (ssq == null) {
            return null;
        }
