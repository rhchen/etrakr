...
public class ControlFlowView extends AbstractTimeGraphView {
     ...
     * View ID.
     */
    public static final String ID = "net.sf.etrakr.ftrace.ui.views.controlflow.ControlFlowView"; //$NON-NLS-1$
    ...
    protected void fillLocalToolBar(IToolBarManager manager) {
        ...
        IDialogSettings settings = FtracePlugin.getDefault().getDialogSettings();
    ...
    protected void buildEventList(final ITmfTrace trace, ITmfTrace parentTrace, IProgressMonitor monitor) {
        ...
        ITmfStateSystem ssq = TmfStateSystemAnalysisModule.getStateSystem(trace, FtraceAnalysisModule.ID);
        if (ssq == null) {
            return;
        }
