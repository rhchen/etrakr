 ...
 **********************************************************************/
package net.sf.etrakr.application.app;
    ...
    public Object start(IApplicationContext context) throws Exception {
        ...
        try {
            ...
            if (!fInstanceLoc.allowsDefault() && !fInstanceLoc.isSet()) {
                File workspaceRoot = new File(ApplicationActivator.getWorkspaceRoot());

                if (!workspaceRoot.exists()) {
                    MessageDialog.openError(display.getActiveShell(),
                            Messages.Application_WorkspaceCreationError,
                            MessageFormat.format(Messages.Application_WorkspaceRootNotExistError, new Object[] { ApplicationActivator.getWorkspaceRoot() }));
                ...
                if (!workspaceRoot.canWrite()) {
                    MessageDialog.openError(display.getActiveShell(),
                            Messages.Application_WorkspaceCreationError,
                            MessageFormat.format(Messages.Application_WorkspaceRootPermissionError, new Object[] { ApplicationActivator.getWorkspaceRoot() }));
                    return IApplication.EXIT_OK;
                }

                String workspace = ApplicationActivator.getWorkspaceRoot() + File.separator + ApplicationActivator.WORKSPACE_NAME;
