package net.sf.etrakr.ctrace.core.event.impl;
...
public class CtraceEvent extends TmfEvent implements ITmfEvent, ICtraceEvent{
	...
	@Override
	public ICtraceEvent newEvent(ITmfTrace fTrace) {
        ...
        return new CtraceEvent(fTrace, fRank, fTimestamp, fSource, fType, fContent, fReference, sourceCPU, eventName);
	}
