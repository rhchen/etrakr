/*******************************************************************************
 * Copyright (c) 2013, 2014 �cole Polytechnique de Montr�al
 *
...
package net.sf.etrakr.ctrace.ui.analysis;
...
public class TmfAnalysisViewOutput implements IAnalysisOutput, IExecutableExtension {
    ...
    private final Map<String, String> fProperties = Maps.<String, String>newHashMap();
        ...
        Display.getDefault().asyncExec(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    CtracePlugin.getDefault().logError("Error opening view " + getName(), e); //$NON-NLS-1$
                }
            }
        });
    }
    ...
    @Override
    public void setOutputProperty(String key, String value, boolean immediate) {
