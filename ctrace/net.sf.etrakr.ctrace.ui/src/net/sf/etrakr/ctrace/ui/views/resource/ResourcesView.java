...
package net.sf.etrakr.ctrace.ui.views.resource;
...
import net.sf.etrakr.ctrace.ui.views.resource.ResourcesEntry.Type;
...
public class ResourcesView extends AbstractTimeGraphView {
    ...
    /** View ID. */
    public static final String ID = "net.sf.etrakr.ctrace.ui.views.resource.ResourcesView"; //$NON-NLS-1$
