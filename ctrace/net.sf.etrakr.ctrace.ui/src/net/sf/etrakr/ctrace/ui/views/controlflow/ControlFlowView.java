...
package net.sf.etrakr.ctrace.ui.views.controlflow;
...
import net.sf.etrakr.ctrace.ui.CtracePlugin;
import net.sf.etrakr.ctrace.ui.Messages;
...
public class ControlFlowView extends AbstractTimeGraphView {
     ...
     * View ID.
     */
    public static final String ID = "net.sf.etrakr.ctrace.ui.views.controlflow.ControlFlowView"; //$NON-NLS-1$
    ...
    protected void fillLocalToolBar(IToolBarManager manager) {
        ...
        IDialogSettings settings = CtracePlugin.getDefault().getDialogSettings();
    ...
    protected void buildEventList(final ITmfTrace trace, ITmfTrace parentTrace, IProgressMonitor monitor) {
        ...
        List<ControlFlowEntry> entryList = Lists.<ControlFlowEntry>newArrayList();
        Map<Integer, ControlFlowEntry> entryMap = Maps.<Integer, ControlFlowEntry>newHashMap();
    ...
    private void updateTree(List<ControlFlowEntry> entryList, ITmfTrace parentTrace) {
        List<TimeGraphEntry> rootListToAdd = Lists.<TimeGraphEntry>newArrayList();
        List<TimeGraphEntry> rootListToRemove = Lists.<TimeGraphEntry>newArrayList();
