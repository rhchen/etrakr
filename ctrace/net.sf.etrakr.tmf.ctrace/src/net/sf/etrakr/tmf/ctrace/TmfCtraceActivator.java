package net.sf.etrakr.tmf.ctrace;
...
public class TmfCtraceActivator extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "net.sf.etrakr.tmf.ctrace"; //$NON-NLS-1$
		
	private static BundleContext context;

	// The shared instance
	private static TmfCtraceActivator plugin;
	...
	public void start(BundleContext bundleContext) throws Exception {
		TmfCtraceActivator.context = bundleContext;
		plugin = this;
	}
	...
	public void stop(BundleContext bundleContext) throws Exception {
		plugin = null;
		TmfCtraceActivator.context = null;
	}
	 ...
	 */
	public static TmfCtraceActivator getDefault() {
		return plugin;
	}
