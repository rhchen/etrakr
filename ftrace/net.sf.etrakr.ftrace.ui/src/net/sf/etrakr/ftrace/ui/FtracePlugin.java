package net.sf.etrakr.ftrace.ui;
 ...
 */
public class FtracePlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "net.sf.etrakr.ftrace.ui"; //$NON-NLS-1$

	// The shared instance
	private static FtracePlugin plugin;
	 ...
	 */
	public static FtracePlugin getDefault() {
		return plugin;
	}
