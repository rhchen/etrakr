 ...
 *     Atsuhiko Yamanaka, JCraft,Inc. - adding methods for using IAdbLocation
 *******************************************************************************/
...
public interface IAdbService{
   ...
   * <p>
   * Calling this method does not connect the session (see {@link #connect(Session, int, ICmdProgressMonitor)}, if connection
   ...
   */
  public abstract AdbSession createSession(String host, int port, String username)
      throws AdbException;
   ...
   * @since 1.1
   */
  public abstract AdbSession createSession(IAdbLocation location, IUserInfo uinfo)
  throws AdbException;
   ...
   */
  public abstract void connect(AdbSession session, int timeout,
      IProgressMonitor monitor) throws AdbException;
   ...
   * if no proxy is specified for the host
   */
  public abstract IProxy getProxyForHost(String host, String proxyType);
   ...
   */
  public abstract void connect(IProxy proxy, String host, int port, int timeout,
      IProgressMonitor monitor) throws AdbException;

  /**
   * Get the IAdbLocation according to given user name, host name and port number.
   *
   ...
   * @return the created IAdbLocation
   * @since 1.1
   */
  public abstract IAdbLocation getLocation(String user, String host, int port);
